        ...
        <div className="flex flex-col">
          ...
          <div className="space-y-12 relative raleway mt-10 pb-10">
            ...
            <div className="relative pl-12">
              ...
              <h4 className="text-xl font-bold mb-2">Abastecimiento Ético</h4>
            ...
            <div className="relative pl-12">
              ...
              <h4 className="text-xl font-bold mb-2">Extracción Molecular</h4>
              <p className="text-[#0d40a5]">
            ...
            <div className="relative pl-12">
              ...
              <h4 className="text-xl font-bold mb-2">Síntesis Clínica</h4>
              <p className="text-[#0d40a5]">
