...
import { Eye, Edit, Video, ImageIcon, Layout, BookOpen } from "lucide-react";
...
const MOCK_SECTIONS: HomeSection[] = [
  {
    ...
    content:
      "Documentación técnica para distribuidores y profesionales de la salud.",
    accentColor: "#00e5ff",
    mediaType: "image",
    videoMuted: true,
...
export default function ResourcesEditor() {
  ...
  const loadAvailableImages = async () => {
    ...
    ["heroSection-img.jpg", "MethImage.jpg", "img1-grid-product.jpg"].forEach((img) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        files
          ...
          .forEach((f) => {
            images.push({ src: `http://localhost:3001/uploads/${f}`, name: f, type: "upload" });
          });
      }
    } catch {}
      ...
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <div className="border-b border-gray-200 mb-6">
          <div className="flex items-center gap-2 py-2 px-1 border-b-2 border-[#0d40a5] w-fit">
            ...
            <span className="text-sm font-medium text-[#0d40a5]">Secciones de Contenido</span>
          </div>
        </div>
